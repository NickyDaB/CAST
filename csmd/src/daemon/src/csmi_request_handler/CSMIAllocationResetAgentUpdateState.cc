/*================================================================================
    ...
    csmd/src/daemon/src/csmi_request_handler/CSMIAllocationResetAgentUpdateState.cc
...
bool AllocationResetAgentUpdateState::HandleNetworkMessage(
...
bool AllocationResetAgentUpdateState::InitNode( 
...
bool AllocationResetAgentUpdateState::RevertNode( 
        csmi_allocation_mcast_payload_request_t *payload,
        csmi_allocation_mcast_payload_response_t *respPayload,
    std::vector<csm::daemon::CoreEvent*>& postEventList,
    csm::daemon::EventContextHandlerState_sptr& ctx )
...
void AllocationResetAgentUpdateState::DataAggregators(
...
void AllocationResetAgentUpdateState::AfterPrologDataAggregators(
    csmi_allocation_mcast_payload_response_t *payload)
{
    try
    {
...
void AllocationResetAgentUpdateState::HandleError(
    csm::daemon::EventContextHandlerState_sptr& ctx,
...
int AllocationResetAgentUpdateState::RegisterAllocation( int64_t allocationId, const char* username, bool shared )
{ 
...
int AllocationResetAgentUpdateState::RemoveAllocation( int64_t allocationId )
{
