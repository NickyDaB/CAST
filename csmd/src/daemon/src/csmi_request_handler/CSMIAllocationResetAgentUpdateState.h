/*================================================================================
    ...
    csmd/src/daemon/src/csmi_request_handler/CSMIAllocationResetAgentUpdateState.h
...
================================================================================*/
#ifndef CSMIALLOCATION_RESET_AGENT_UPDATE_STATE_H
#define CSMIALLOCATION_RESET_AGENT_UPDATE_STATE_H
 ...
 * @param fail_state   
 */
class AllocationResetAgentUpdateState: public NetworkMessageState
{
