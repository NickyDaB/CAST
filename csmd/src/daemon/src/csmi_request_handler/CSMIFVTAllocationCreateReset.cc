/*================================================================================
    ...
    csmd/src/daemon/src/csmi_request_handler/CSMIFVTAllocationCreateReset.cc
...
#define STATE_NAME "CSMIFVTAllocationCreateReset:"
...
CSMIFVTAllocationCreateReset_Master::CSMIFVTAllocationCreateReset_Master(csm::daemon::HandlerOptions& options) :
...
bool CSMIFVTAllocationCreateReset_Master::CreatePayload(
...
bool CSMIFVTAllocationCreateReset_Master::ReserveNodes(
...
csm::db::DBReqContent* CSMIFVTAllocationCreateReset_Master::UndoAllocationDB(
    csm::daemon::EventContextHandlerState_sptr& ctx,
...
csm::db::DBReqContent* CSMIFVTAllocationCreateReset_Master::InsertStatsStatement( 
    csm::daemon::EventContextHandlerState_sptr& ctx,
    MCAST_PROPS_PAYLOAD* mcastProps)
{
...
bool CSMIFVTAllocationCreateReset_Master::UndoTerminal( 
    const std::vector<csm::db::DBTuple *>& tuples,
...
bool CSMIFVTAllocationCreateReset_Master::CreateByteArray(
        const std::vector<csm::db::DBTuple *>&tuples,
        char **buf, uint32_t &bufLen,
        csm::daemon::EventContextHandlerState_sptr& ctx )
{
...
CSMIFVTAllocationCreateReset_Agent::CSMIFVTAllocationCreateReset_Agent( csm::daemon::HandlerOptions& options ) : 
