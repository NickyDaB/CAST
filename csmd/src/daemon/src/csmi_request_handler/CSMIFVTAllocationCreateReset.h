/*================================================================================
    csmd/src/daemon/src/csmi_request_handler/CSMIFVTAllocationCreateReset.h
...
================================================================================*/
/**
 * @file CSMIFVTAllocationCreateReset.h
 *
 * @author John Dunham (jdunham@us.ibm.com)
 */
    
#ifndef __CSMI_FVT_ALLOCATION_CREATE_RESET__
 ...
 * 
 */
class CSMIFVTAllocationCreateReset_Master : public CSMIStatefulDB
{
public:
    CSMIFVTAllocationCreateReset_Master(csm::daemon::HandlerOptions& options) ;
     ...
     * Invokes @ref CSMIFVTAllocationCreateReset_Master.CreateByteArray
     *
 ...
 *
 */
class CSMIFVTAllocationCreateReset_Agent : public CSMIStateful
{
public:
    CSMIFVTAllocationCreateReset_Agent( csm::daemon::HandlerOptions& options ); 
};
