/*================================================================================
    ...
    csmd/src/daemon/src/csmi_request_handler/csmi_mcast/CSMIMcastAllocation_reset.h
...
/**
 * @file CSMIMcastAllocation_reset.h
 * @author John Dunham (jdunham@us.ibm)
 */

#ifndef CSMI_MCAST_ALLOCATION_RESET 
#define CSMI_MCAST_ALLOCATION_RESET 
 ...
 *
 * The Parse operation saves values to @ref CSMIMcastAllocation_reset::_Data.
 *
 ...
 */
bool ParseResponseCreate(CSMIMcastAllocation_reset* mcastProps,
 ...
 * @return True if the response is valid.
 */
bool ParseResponseDelete(CSMIMcastAllocation_reset* mcastProps,
    const csm::network::MessageAndAddress content);
...
/** @brief Parses a message payload for a Recovery Operation.
  ...
  * @return True if the response is valid.
  */
bool ParseResponseRecover(CSMIMcastAllocation_reset* mcastProps,
    const csm::network::MessageAndAddress content);
}
}
}
