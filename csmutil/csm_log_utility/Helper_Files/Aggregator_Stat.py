...
def compute_CSM_Aggregator_stats(filename, start_datetime, end_datetime, order_by, reverse_order, reports_path):
    ...
    report_file_path = reports_path + '/Aggregator_Reports/'+ filename +'.txt'
