...
def compute_CSM_Compute_stats(filename, start_datetime, end_datetime, order_by, reverse_order, reports_path):
    ...
    report_file_path = reports_path + '/Compute_Reports/'+ filename +'.txt'
