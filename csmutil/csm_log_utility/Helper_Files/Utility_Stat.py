...
def compute_CSM_Utility_stats(filename, start_datetime, end_datetime, order_by, reverse_order, reports_path):
    ...
    report_file_path = reports_path + '/Utility_Reports/'+ filename +'.txt'
